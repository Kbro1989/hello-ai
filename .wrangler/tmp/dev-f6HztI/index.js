...
// .wrangler/tmp/bundle-qA3uI6/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-qA3uI6/middleware-insertion-facade.js
init_modules_watch_stub();
...
// src/utils/geometryOptimizer.ts
init_modules_watch_stub();
function optimizeGeometry(geometry, changes) {
  console.warn("optimizeGeometry: Not yet implemented. Returning original geometry.");
  return geometry;
}
__name(optimizeGeometry, "optimizeGeometry");
...
var AIModelService = class {
  ...
  static {
    __name(this, "AIModelService");
  }
  async evolveModel(model, prompt) {
  ...
  async getAISuggestions(model, prompt) {
...
Focus on: topology optimization, texture enhancement, and geometric refinement.`;
  ...
  async applyEvolution(model, changes, prompt) {
...
__name(ushortToHalf, "ushortToHalf");
function flipEndian16(u16) {
  return (u16 & 255) << 8 | (u16 & 65280) >>> 8;
}
__name(flipEndian16, "flipEndian16");
function HSL2RGBfloat(hsl) {
  ...
  if (s == 0) {
    ...
    var hue2rgb2 = /* @__PURE__ */ __name(function hue2rgb3(p3, q2, t2) {
      if (t2 < 0) t2 += 1;
      if (t2 > 1) t2 -= 1;
    ...
    g2 = hue2rgb2(p2, q, h2);
    b = hue2rgb2(p2, q, h2 - 1 / 3);
  }
  return [r2, g2, b];
}
__name(HSL2RGBfloat, "HSL2RGBfloat");
...
__name(packedHSL2HSL, "packedHSL2HSL");

// src/rsmv/node_modules/three/build/three.module.js
init_modules_watch_stub();
var REVISION = "162";
var CullFaceNone = 0;
var CullFaceBack = 1;
...
var Matrix3 = class _Matrix3 {
  ...
  determinant() {
    const te = this.elements;
    const a = te[0], b = te[1], c = te[2], d = te[3], e = te[4], f2 = te[5], g2 = te[6], h2 = te[7], i = te[8];
    return a * e * i - a * f2 * h2 - b * d * i + b * f2 * g2 + c * d * h2 - c * e * g2;
  }
  invert() {
...
function WebGLBackground(renderer, cubemaps, cubeuvmaps, state, objects, alpha, premultipliedAlpha) {
  ...
  return {
    getClearColor: /* @__PURE__ */ __name(function() {
      return clearColor;
    }, "getClearColor"),
    setClearColor: /* @__PURE__ */ __name(function(color, alpha2 = 1) {
      clearColor.set(color);
      clearAlpha = alpha2;
      setClear(clearColor, clearAlpha);
    }, "setClearColor"),
    getClearAlpha: /* @__PURE__ */ __name(function() {
      return clearAlpha;
    }, "getClearAlpha"),
    setClearAlpha: /* @__PURE__ */ __name(function(alpha2) {
      clearAlpha = alpha2;
      setClear(clearColor, clearAlpha);
    }, "setClearAlpha"),
    render
...
function WebGLBufferRenderer(gl, extensions, info, capabilities) {
  ...
  __name(renderMultiDraw, "renderMultiDraw");
...
__name(_getCubemapMaterial, "_getCubemapMaterial");
...
function WebGLCubeUVMaps(renderer) {
  ...
  __name(isCubeTextureComplete, "isCubeTextureComplete");
  function onTextureDispose(event) {
    const texture = event.target;
    texture.removeEventListener("dispose", onTextureDispose);
...
__name(WebGLCubeUVMaps, "WebGLCubeUVMaps");
function WebGLExtensions(gl) {
  ...
  return {
    has: /* @__PURE__ */ __name(function(name) {
      return getExtension(name) !== null;
    }, "has"),
    init: /* @__PURE__ */ __name(function(capabilities) {
  ...
  function update(object, geometry, program) {
    ...
    if (capabilities.isWebGL2 === true) {
      ...
      if (entry === void 0 || entry.count !== morphTargetsCount) {
        ...
        __name(disposeTexture, "disposeTexture");
...
__name(setValueV2ui, "setValueV2ui");
...
__name(setValueV3ui, "setValueV3ui");
...
__name(setValueV4ui, "setValueV4ui");
...
__name(setValueV1uiArray, "setValueV1uiArray");
function setValueV2uiArray(gl, v) {
  gl.uniform2uiv(this.addr, v);
}
__name(setValueV2uiArray, "setValueV2uiArray");
function setValueV3uiArray(gl, v) {
  gl.uniform3uiv(this.addr, v);
}
__name(setValueV3uiArray, "setValueV3uiArray");
function setValueV4uiArray(gl, v) {
  gl.uniform4uiv(this.addr, v);
}
__name(setValueV4uiArray, "setValueV4uiArray");
...
__name(setValueT3DArray, "setValueT3DArray");
...
__name(setValueT2DArrayArray, "setValueT2DArrayArray");
...
__name(generateCubeUVSize, "generateCubeUVSize");
...
function WebGLPrograms(renderer, cubemaps, cubeuvmaps, extensions, capabilities, bindingStates, clipping) {
  ...
  __name(getProgramCacheKeyParameters, "getProgramCacheKeyParameters");
  ...
  __name(getProgramCacheKeyBooleans, "getProgramCacheKeyBooleans");
  ...
  __name(releaseShaderCache, "releaseShaderCache");
  function dispose() {
...
function UniformsCache() {
  const lights = {};
  return {
    get: /* @__PURE__ */ __name(function(light) {
...
__name(shadowCastingAndTexturingLightsFirst, "shadowCastingAndTexturingLightsFirst");
...
var MeshDistanceMaterial = class extends Material {
  static {
    __name(this, "MeshDistanceMaterial");
  }
  constructor(parameters) {
    super();
...
function WebGLState(gl, extensions, capabilities) {
  ...
  function ColorBuffer() {
    ...
    return {
      setMask: /* @__PURE__ */ __name(function(colorMask) {
        if (currentColorMask !== colorMask && !locked) {
          gl.colorMask(colorMask, colorMask, colorMask, colorMask);
          currentColorMask = colorMask;
        }
      }, "setMask"),
      setLocked: /* @__PURE__ */ __name(function(lock) {
        locked = lock;
      }, "setLocked"),
      setClear: /* @__PURE__ */ __name(function(r2, g2, b, a, premultipliedAlpha) {
  ...
  function DepthBuffer() {
    ...
    return {
      setTest: /* @__PURE__ */ __name(function(depthTest) {
        if (depthTest) {
      ...
      setMask: /* @__PURE__ */ __name(function(depthMask) {
        if (currentDepthMask !== depthMask && !locked) {
          gl.depthMask(depthMask);
          currentDepthMask = depthMask;
        }
      }, "setMask"),
      setFunc: /* @__PURE__ */ __name(function(depthFunc) {
      ...
      setClear: /* @__PURE__ */ __name(function(depth) {
  ...
  function StencilBuffer() {
    ...
    return {
      setTest: /* @__PURE__ */ __name(function(stencilTest) {
        if (!locked) {
          if (stencilTest) {
      ...
      setMask: /* @__PURE__ */ __name(function(stencilMask) {
        if (currentStencilMask !== stencilMask && !locked) {
          gl.stencilMask(stencilMask);
          currentStencilMask = stencilMask;
        }
      }, "setMask"),
      setFunc: /* @__PURE__ */ __name(function(stencilFunc, stencilRef, stencilMask) {
      ...
      setOp: /* @__PURE__ */ __name(function(stencilFail, stencilZFail, stencilZPass) {
      ...
      setClear: /* @__PURE__ */ __name(function(stencil) {
  ...
  __name(bindFramebuffer, "bindFramebuffer");
  ...
  __name(drawBuffers, "drawBuffers");
  ...
  __name(compressedTexImage3D, "compressedTexImage3D");
  ...
  __name(texSubImage2D, "texSubImage2D");
  ...
  __name(texSubImage3D, "texSubImage3D");
  ...
  __name(compressedTexSubImage2D, "compressedTexSubImage2D");
  ...
  __name(compressedTexSubImage3D, "compressedTexSubImage3D");
  ...
  __name(texStorage2D, "texStorage2D");
  ...
  __name(texStorage3D, "texStorage3D");
  function texImage2D() {
    try {
  ...
  __name(updateUBOMapping, "updateUBOMapping");
  ...
  __name(uniformBlockBinding, "uniformBlockBinding");
  function reset() {
    gl.disable(gl.BLEND);
...
function WebGLTextures(_gl, extensions, state, properties, capabilities, utils, info) {
  ...
  const supportsInvalidateFramebuffer = typeof navigator === "undefined" ? false : /OculusBrowser/g.test("Cloudflare-Workers");
  ...
  __name(isPowerOfTwo$1, "isPowerOfTwo$1");
  ...
  __name(getMipLevels, "getMipLevels");
  ...
  __name(deleteTexture, "deleteTexture");
  ...
  __name(getTextureCacheKey, "getTextureCacheKey");
  ...
  __name(rebindTextures, "rebindTextures");
  ...
  __name(useMultisampledRTT, "useMultisampledRTT");
  ...
  __name(verifyColorSpace, "verifyColorSpace");
...
var WebXRManager = class extends EventDispatcher {
  ...
  constructor(renderer, gl) {
    ...
    __name(updateUserCamera, "updateUserCamera");
...
function WebGLMaterials(renderer, properties) {
  ...
  __name(refreshTransformUniform, "refreshTransformUniform");
...
function WebGLUniformsGroups(gl, info, capabilities, state) {
  ...
  __name(allocateBindingPointIndex, "allocateBindingPointIndex");
  ...
  __name(updateBufferData, "updateBufferData");
  ...
  __name(hasUniformChanged, "hasUniformChanged");
  ...
  __name(prepareUniformsGroup, "prepareUniformsGroup");
  ...
  __name(getUniformSize, "getUniformSize");
  ...
  __name(onUniformsGroupsDispose, "onUniformsGroupsDispose");
  function dispose() {
...
__name(WebGLUniformsGroups, "WebGLUniformsGroups");
var WebGLRenderer = class {
  ...
  constructor(parameters = {}) {
    ...
    __name(onContextCreationError, "onContextCreationError");
    function onMaterialDispose(event) {
      const material = event.target;
      material.removeEventListener("dispose", onMaterialDispose);
    ...
    __name(releaseMaterialProgramReferences, "releaseMaterialProgramReferences");
    ...
    __name(prepareMaterial, "prepareMaterial");
    ...
    this.compileAsync = function(scene, camera, targetScene = null) {
      ...
      return new Promise((resolve) => {
        ...
        __name(checkMaterialsReady, "checkMaterialsReady");
    ...
    __name(onXRSessionStart, "onXRSessionStart");
    function onXRSessionEnd() {
      animation.start();
    }
    __name(onXRSessionEnd, "onXRSessionEnd");
    const animation = new WebGLAnimation();
    animation.setAnimationLoop(onAnimationFrame);
    ...
    __name(renderScene, "renderScene");
    ...
    __name(renderTransmissionPass, "renderTransmissionPass");
    ...
    __name(getUniformList, "getUniformList");
...
function resolveAlias(typename, parent, typedef) {
  if (!Object.hasOwn(typedef, typename)) {
    throw new Error(`Type '${typename}' not found in typedef.jsonc`);
  }
  ...
  let r2 = {
    read(state) {
      ...
      while (true) {
        ...
        r3[parser.key] = parser.parser.read(state);
      }
      state.stack.pop();
    ...
    getTypescriptType(indent) {
      ...
      for (let val of map.values()) {
        r3 += newindent + val.key + "?: " + val.parser.getTypescriptType(newindent) + " | null\n";
      }
      r3 += indent + "}";
      return r3;
    },
...
function tuppleParser(args, parent, typedef) {
  let r2 = {
    ...
    getTypescriptType(indent) {
      ...
      let newindent = indent + "	";
      for (let prop of props) {
        r3 += newindent + prop.getTypescriptType(newindent) + ",\n";
      }
      r3 += indent + "]";
      return r3;
    },
...
function conditionParser(parent, optionstrings, writegetindex) {
  ...
  let match = /* @__PURE__ */ __name((state) => {
...
function structParser(args, parent, typedef) {
  ...
  let r2 = {
    ...
    write(state, value) {
      throw new Error("Writing not implemented in structParser");
    },
    getTypescriptType(indent) {
      let r3 = "{\n";
      let newindent = indent + "	";
      for (let key of keys) {
        ...
        r3 += newindent + key + ": " + props[key].getTypescriptType(newindent) + ",\n";
      }
      r3 += indent + "}";
      return r3;
    },
...
function chunkedArrayParser(args, parent, typedef) {
  let r2 = {
    ...
    getTypescriptType(indent) {
      ...
      for (let [key, prop] of Object.entries(fullobj)) {
        ...
        r3 += newindent + key + ": " + prop.getTypescriptType(newindent) + ",\n";
      }
      r3 += indent + "}[]";
      return r3;
    },
  ...
  for (let chunk of rawchunks) {
    ...
    for (let propdef of chunk) {
      ...
      let p2 = buildParser(resolveReference.bind(null, propdef[0]), propdef[1], typedef);
      group[propdef[0]] = p2;
      fullobj[propdef[0]] = p2;
    }
  }
...
function bufferParser(args, parent, typedef) {
  let r2 = {
    ...
    write(state, rawvalue) {
      throw new Error("Writing not implemented in bufferParser");
    },
    getTypescriptType(indent) {
  ...
  return {
    read(state) {
      ...
      for (let i = 0; i < prebytes.length; i++, state.scan++) {
        if (new DataView(state.buffer.buffer, state.buffer.byteOffset).getUint8(state.scan) != prebytes[i]) {
      ...
      while (true) {
        ...
        if (new DataView(state.buffer.buffer, state.buffer.byteOffset).getUint8(end) == terminator) {
          break;
        }
        end++;
      }
    ...
    write(state, value) {
      ...
      let terminator = getClientVersion(state.args) <= lastLegacyBuildnr ? 10 : 0;
      let writebytes = new Uint8Array([...prebytes, ...new TextEncoder().encode(value), terminator]);
...
var hardcodes = {
  // Hardcoded parsers are not implemented for now
};
...
var numberTypes = {
  ubyte: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan);
      s.scan += 1;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint8(s.scan, v);
      s.scan += 1;
    }, "write"),
    min: 0,
    max: 255
  ...
  byte: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getInt8(s.scan);
      s.scan += 1;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setInt8(s.scan, v);
      s.scan += 1;
    }, "write"),
    min: -128,
    max: 127
  ...
  ushort: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint16(s.scan, false);
      s.scan += 2;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint16(s.scan, v, false);
      s.scan += 2;
    }, "write"),
    min: 0,
    max: 2 ** 16 - 1
  ...
  short: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getInt16(s.scan, false);
      s.scan += 2;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setInt16(s.scan, v, false);
      s.scan += 2;
    }, "write"),
    min: -(2 ** 15),
    max: 2 ** 15 - 1
  ...
  uint: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint32(s.scan, false);
      s.scan += 4;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint32(s.scan, v, false);
      s.scan += 4;
    }, "write"),
    min: 0,
    max: 2 ** 32 - 1
  ...
  int: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getInt32(s.scan, false);
      s.scan += 4;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setInt32(s.scan, v, false);
      s.scan += 4;
    }, "write"),
    min: -(2 ** 31),
    max: 2 ** 31 - 1
  ...
  uint_le: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint32(s.scan, true);
      s.scan += 4;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint32(s.scan, v, true);
      s.scan += 4;
    }, "write"),
    min: 0,
    max: 2 ** 32 - 1
  ...
  ushort_le: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint16(s.scan, true);
      s.scan += 2;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint16(s.scan, v, true);
      s.scan += 2;
    }, "write"),
    min: 0,
    max: 2 ** 16 - 1
  ...
  utribyte: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan) << 16 | new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan + 1) << 8 | new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan + 2);
      s.scan += 3;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint8(s.scan, v >> 16 & 255);
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint8(s.scan + 1, v >> 8 & 255);
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setUint8(s.scan + 2, v & 255);
      s.scan += 3;
    }, "write"),
    min: 0,
    max: 2 ** 24 - 1
  ...
  float: {
    read: /* @__PURE__ */ __name((s) => {
      let r2 = new DataView(s.buffer.buffer, s.buffer.byteOffset).getFloat32(s.scan, false);
      s.scan += 4;
      return r2;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      new DataView(s.buffer.buffer, s.buffer.byteOffset).setFloat32(s.scan, v, false);
      s.scan += 4;
    }, "write"),
  ...
  varushort: {
    read: /* @__PURE__ */ __name((s) => {
      let firstByte = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan++);
      if ((firstByte & 128) == 0) {
        return firstByte;
      }
      let secondByte = new DataView(s.buffer.buffer, s.buffer.byteOffset).getUint8(s.scan++);
      return (firstByte & 127) << 8 | secondByte;
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      throw new Error("Writing varushort not implemented");
    }, "write"),
    min: 0,
    max: 2 ** 15 - 1
  },
  varshort: {
    read: /* @__PURE__ */ __name((s) => {
      throw new Error("Reading varshort not implemented");
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      throw new Error("Writing varshort not implemented");
    }, "write"),
    min: -(2 ** 14),
    max: 2 ** 14 - 1
  },
  varuint: {
    read: /* @__PURE__ */ __name((s) => {
      throw new Error("Reading varuint not implemented");
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      throw new Error("Writing varuint not implemented");
    }, "write"),
    min: 0,
    max: 2 ** 31 - 1
  },
  varnullint: {
    read: /* @__PURE__ */ __name((s) => {
      throw new Error("Reading varnullint not implemented");
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      throw new Error("Writing varnullint not implemented");
    }, "write"),
    min: -1,
    max: 2 ** 31 - 1
  },
  varint: {
    read: /* @__PURE__ */ __name((s) => {
      throw new Error("Reading varint not implemented");
    }, "read"),
    write: /* @__PURE__ */ __name((s, v) => {
      throw new Error("Writing varint not implemented");
    }, "write"),
    min: -(2 ** 30),
    max: 2 ** 30 - 1
  }
...
var models_default = [
  ...
  ["unkCount2", "ubyte"],
  ["unkCount3", "ubyte"],
  ["unkCount4", ["match", "version", { "version>=5": "ubyte", other: 0 }]],
  [
    "meshes",
    ["opt", "version<=3", ["array", ["ref", "meshCount"], [
      "struct",
      ["$groupFlags", "ubyte"],
      ["unkint", "uint"],
...
var typedef_default = {
  ...
  playeritemedit: [
    ...
    ["color", ["opt", ["$type", 2, "bitflag"], [
      "struct",
      ["$coltype", "ushort"],
      ["col2", ["opt", ["$coltype", 12816], ["array", 4, ["tuple", "ushort", "ushort"]]]],
...
var FileParser = class _FileParser {
  constructor(opcodeobj, originalSource) {
    this.totaltime = 0;
    this.parser = buildParser(null, opcodeobj, typedef_default);
  ...
  static fromJson(jsonObject) {
    return new _FileParser(jsonObject, JSON.stringify(jsonObject));
  }
  readInternal(state) {
    let t2 = performance.now();
    let res = this.parser.read(state);
    this.totaltime += performance.now() - t2;
    if (state.scan != state.endoffset) {
  ...
  write(obj, args) {
    ...
    scratchbuf.set(scratchbuf.subarray(state.endoffset, scratchbuf.byteLength), state.scan);
    state.scan += scratchbuf.byteLength - state.endoffset;
    let r2 = scratchbuf.slice(0, state.scan);
...
function allParsers() {
  return {
    models: FileParser.fromJson(models_default)
  };
}
__name(allParsers, "allParsers");

// src/rsmv/rt7model.ts
function parsePosData(arr) {
  return new BufferAttribute(new Float32Array(arr), 3);
}
__name(parsePosData, "parsePosData");
function addBoneIdBuffer(attributes, boneidBuffer) {
  ...
  attributes.boneids = new BufferAttribute(quadboneids, 4);
  attributes.boneweights = new BufferAttribute(quadboneweights, 4, true);
}
__name(addBoneIdBuffer, "addBoneIdBuffer");
function addUvBuffer(attributes, vertexCount, uvBuffer) {
  if (uvBuffer instanceof Uint16Array) {
    ...
    attributes.texuvs = new BufferAttribute(uvBufferCopy, 2);
  } else {
    attributes.texuvs = new BufferAttribute(uvBuffer, 2);
  }
}
__name(addUvBuffer, "addUvBuffer");
function addNormalsBuffer(attributes, normalBuffer) {
  ...
  attributes.normals = new BufferAttribute(normalsrepacked, 3, true);
}
__name(addNormalsBuffer, "addNormalsBuffer");
function parseOb3Model(modelfile, source) {
  ...
  if (parsed.meshes) {
    for (let mesh of parsed.meshes) {
      ...
      let indexlods = indexBuffers.map((q) => new BufferAttribute(q, 1));
      ...
      if (mesh.skin) {
        ...
        attributes.skinids = new BufferAttribute(skinIdBuffer, 4);
        attributes.skinweights = new BufferAttribute(skinWeightBuffer, 4, true);
      }
      if (mesh.colourBuffer) {
        ...
        for (let i = 0; i < mesh.faceCount; i++) {
          let [r2, g2, b] = HSL2RGB(packedHSL2HSL(mesh.colourBuffer[i]));
          for (let j = 0; j < 3; j++) {
            let index = indexbuf[i * 3 + j] * 4;
            vertexcolor[index + 0] = r2;
            vertexcolor[index + 1] = g2;
        ...
        attributes.color = new BufferAttribute(vertexcolor, 4, true);
      }
    ...
    if (mesh.vertexColours) {
      ...
      for (let i = 0; i < mesh.vertexColours.length; i++) {
        let [r2, g2, b] = HSL2RGB(packedHSL2HSL(mesh.vertexColours[i]));
    ...
    for (let render of mesh.renders) {
      ...
      let index = new BufferAttribute(buf, 1);
      meshes.push({
        indices: index,
...
__name(parseOb3Model, "parseOb3Model");
function makeModelData(meshes) {
  ...
  let r2 = { maxy, miny, meshes, bonecount, skincount };
  return r2;
}
__name(makeModelData, "makeModelData");

// src/services/cacheService.ts
init_modules_watch_stub();
var WorkerCacheFileSource = class {
  static {
    __name(this, "WorkerCacheFileSource");
  }
  constructor(env) {
    this.kv = env.CACHE_KV;
  }
  async getFile(index, fileId, decompression) {
    const key = `cache/${index}/${fileId}`;
    const data = await this.kv.get(key, { type: "arrayBuffer" });
    if (data) {
      return new Uint8Array(data);
    }
    console.warn(`Cache file not found: ${key}`);
    return new Uint8Array();
  }
  async getFileById(fileid, decompression) {
    const key = `cache/by-id/${fileid}`;
    const data = await this.kv.get(key, { type: "arrayBuffer" });
    if (data) {
      return new Uint8Array(data);
    }
    console.warn(`Cache file by ID not found: ${key}`);
    return new Uint8Array();
  }
  getDecodeArgs() {
    return { clientVersion: 900 };
  }
  getFileUrl(index, fileId) {
    return `cache/${index}/${fileId}`;
  }
};

// src/api/model.ts
var router = t();
router.get("/api/model/:id", async (request, env) => {
  const modelId = request.params?.id;
  try {
    const cacheSource = new WorkerCacheFileSource(env);
    const modelUrl = `http://localhost:8787/models/${modelId}.ob3`;
    const response = await fetch(modelUrl);
    if (!response.ok) {
      return new Response(`Failed to fetch model ${modelId}: ${response.statusText}`, { status: response.status });
    }
    const arrayBuffer = await response.arrayBuffer();
    const rawModelData = new Uint8Array(arrayBuffer);
    const parsedModel = parseOb3Model(rawModelData, cacheSource);
      ...
      parsedModel.meshes.forEach((mesh) => {
        ...
        if (colorBuffer) {
          ...
          for (let i = 0; i < mesh.attributes.pos.count; i++) {
            simplifiedModel.colors.push(255, 255, 255, 255);
          }
        }
...
router.post("/api/model/save", async (request, env) => {
  try {
...
var model_default = router;

// src/index.ts
var router2 = t();
router2.all("/api/model/*", model_default.handle);
router2.get("/api/models", listModels);
router2.post("/api/models", uploadModel);
router2.post("/api/models/evolve/:id", evolveModel);
var src_default = {
  async fetch(request, env, ctx) {
    try {
      ...
      try {
        ...
        console.error("Asset Serving Error:", assetError);
        return new Response(`Asset Serving Error: ${assetError.message}`, { status: 500 });
      }
    } catch (error) {
...
async function uploadModel(request, env) {
...
async function evolveModel(request, env, ctx, aiService) {
  const modelId = request.params?.id;
...
__name(evolveModel, "evolveModel");
