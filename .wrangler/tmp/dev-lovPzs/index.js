...
// .wrangler/tmp/bundle-MChUHC/middleware-loader.entry.ts
init_modules_watch_stub();

// .wrangler/tmp/bundle-MChUHC/middleware-insertion-facade.js
init_modules_watch_stub();
...
var src_default = {
  async fetch(request, env, ctx) {
    try {
      ...
      const response = await router2.handle(request, env, ctx, aiService);
      if (response) {
        return response;
      }
      try {
