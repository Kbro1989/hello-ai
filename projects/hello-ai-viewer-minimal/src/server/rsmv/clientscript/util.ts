import enums from "../../../generated-opcodes/enums";
import params from "../../../generated-opcodes/params";
import structs from "../../../generated-opcodes/structs";
import { CacheFileSource } from "../../cache";
import { cacheConfigPages, cacheMajors } from "../../constants";
import { parse } from "../opdecoder";

export async function loadParams(source: EngineCache) {
...
export async function loadEnum(source: EngineCache, id: number) {
...
export async function loadStruct(source: EngineCache, structid: number) {
