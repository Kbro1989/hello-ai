import { ClientScriptFunction, RawOpcodeNode, SubcallNode, generateAst } from "./ast";
import { ExactStack, StackConstants, StackDiff, branchInstructionsInt, branchInstructionsLong, debugKey, decomposeKey, dependencyGroup, dependencyIndex, dynamicOps, knownDependency, namedClientScriptOps, subtypes } from "./definitions";
//to test
...
export function detectSubtypes(calli, candidates) {
...
export function assignKnownTypes(calli, knowntypes) {
