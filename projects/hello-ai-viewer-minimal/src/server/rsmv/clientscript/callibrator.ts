...
import { EngineCache } from "../../rsmv/3d/modeltothree";
import clientscriptdata from "../../../generated-opcodes/clientscriptdata";
import dbtables from "../../../generated-opcodes/dbtables";
import params from "../../../generated-opcodes/params";
import clientscript from "../../../generated-opcodes/clientscript";
...
export class ClientscriptObfuscation {
    ...
    static async fromJson(source: EngineCache, deobjson: ReturnType<ClientscriptObfuscation["toJson"]>, scriptjson: null | ReturnType<ClientscriptObfuscation["getScriptJson"]>) {
    ...
    static async getSaveName(source: EngineCache) {
    ...
    private constructor(source: EngineCache) {
        this.source = source;
    }

    static async create(source: EngineCache, nocached = false) {
    ...
    async runAutoCallibrate(source: EngineCache) {
