...
import { alignedRefOrCopy } from "./gltfutil";
...
export function getBoneCenters(model) {
    let bonecenters = [];
...
export function parseOb3Model(modelfile, source) {
...
export function makeModelData(meshes) {
    let maxy = 0;
    let miny = 0;
    let bonecount = 0;
    let skincount = 0;
