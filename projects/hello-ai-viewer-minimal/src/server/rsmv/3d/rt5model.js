...
import { BoxGeometry, BufferAttribute, CylinderGeometry, LatheGeometry, Matrix3, Matrix4, Mesh, PlaneGeometry, SphereGeometry, Vector2, Vector3 } from "three";
...
export function parseRT5Model(modelfile, source) {
    ...
    for (let i = 0; i < modeldata.facecount; i++) {
        ...
        if (!submesh) {
            throw new Error("material " + matargument + " not found");
        }
