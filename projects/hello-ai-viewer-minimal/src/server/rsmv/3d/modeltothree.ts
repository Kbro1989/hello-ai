...
import { CacheIndex, SubFile } from "../../cache";
...
import { ParsedTexture, SubImageData, parseSprite } from "./sprite";
...
export async function detectTextureMode(source: EngineCache) {
