import { cacheConfigPages, cacheMajors, lastClassicBuildnr, lastLegacyBuildnr, mappedFileIds, oldConfigMaps } from "../../constants";
...
import { ParsedTexture, parseSprite } from "./sprite";
import { combineLegacyTexture, legacyGroups, legacyMajors, legacyPreload, parseLegacyImageFile } from "../../cache/legacycache";
import { classicConfig, ClassicFileSource, classicGroups } from "../../cache/classicloader";
...
// import { minimapLocMaterial } from "./rsmv/rs3shaders"; // Commented out as rs3shaders was not found
