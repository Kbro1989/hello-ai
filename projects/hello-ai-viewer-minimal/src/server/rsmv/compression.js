...
import * as pako from "pako"; // Assuming pako is installed and imported
...
var _zlib = function (input, key) {
    ...
    try {
        ...
        if (key) {
            ...
            return pako.gunzipSync(compressedData.subarray(4, 4 + compressedsize));
        }
        else {
            let compressedData = input.subarray(9, 9 + compressedsize);
            return pako.gunzipSync(compressedData);
        }
    }
    catch (e) {
