export const TextEncoderPolyfill = (typeof TextEncoder != "undefined" ? TextEncoder : require("util").TextEncoder);
export const glTypeIds = {
...
export function alignedRefOrCopy(constr, source, offset, length) {
    let srcbuffer;
...
export function buildAttributeBuffer(attrsources) {
    let format = {};
    let attributes = {};
    let offset = 0;
    let totalalign = 4;
