...
import { StackConstants, StackDiff, StackInOut, StackList, namedClientScriptOps, variableSources, typeToPrimitive, getOpName, knownClientScriptOpNames } from "./definitions";
import { reverseHashes } from "../libs/rshashnames";
import { RawOpcodeNode, generateAst } from "./ast";
...
//TODO move to file
let varInfoParser = new FileParser({
...
export class OpcodeInfo {
    constructor(scrambledid, id, possibles) {
        ...
        this.stackChangeConstraints = new Set();
...
async function getReferenceOpcodeDump() {
    referenceOpcodeDump ?? (referenceOpcodeDump = (async () => {
...
export class ClientscriptObfuscation {
    ...
    constructor(source) {
        ...
        this.opidcounter = 10000;
        this.dbtables = new Map();
        this.varmeta = new Map();
        this.varbitmeta = new Map();
        this.parammeta = new Map();
        this.scriptargs = new Map();
        ...
        this.callibrateSubtypes = callibrateSubtypes;
    ...
    parseCandidateContents() {
        ...
        for (let cand of this.candidates.values()) {
            try {
                cand.scriptcontents ?? (cand.scriptcontents = parse.clientscript.read(cand.buf, this.source, { clientScriptDeob: this }));
            }
            catch (e) { }
            ...
            this.scriptargs.set(cand.id, {
                ...
                stack: new StackInOut(cand.argtype.getArglist(), 
...
export function getArgType(script) {
...
export function getReturnType(calli, ops, endindex = ops.length) {
