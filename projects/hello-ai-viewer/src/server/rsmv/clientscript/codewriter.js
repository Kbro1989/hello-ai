...
import { BranchingStatement, ClientScriptFunction, CodeBlockNode, ComposedOp, FunctionBindNode, IfStatementNode, RawOpcodeNode, SwitchStatementNode, VarAssignNode, WhileLoopStatementNode, getSingleChild, SubcallNode, isNamedOp, RewriteCursor } from "./ast";
import { ClientScriptSubtypeSolver } from "./subtypedetector";
import { binaryOpSymbols, branchInstructionsOrJump, getOpName, int32MathOps, longJsonToBigInt, namedClientScriptOps, popDiscardOps, popLocalOps, subtypeToTs, subtypes } from "./definitions";
...
__decorate([
    boundMethod
], TsWriterContext.prototype, "getCode", null);
    ...
    if (!fulldiscard) {
        ...
        for (let sub of node.varops) {
            ...
            if (popLocalOps.includes(sub.op.opcode)) {
                ...
                hasundeclared || (hasundeclared = !isdeclared);
