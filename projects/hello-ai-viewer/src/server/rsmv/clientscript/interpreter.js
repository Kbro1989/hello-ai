import { StackDiff, StackList, branchInstructions, getParamOps, knownClientScriptOpNames, longBigIntToJson, longJsonToBigInt, namedClientScriptOps, typeToPrimitive } from "./definitions";
import { rs3opnames } from "./opnames";
import { CS2Api, MAGIC_CONST_CURRENTCOMP } from "../scripts/renderrsinterface";
...
export class ClientScriptInterpreter {
    constructor(calli, uictx = null) {
        ...
        this.scope = null;
        this.activecompid = -1;
        this.clientcomps = [undefined, undefined];
