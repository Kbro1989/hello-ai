import { Texture, Buffer as JavaStream } from "../libs/proctexes";
...
export async function loadProcTexture(engine, id, size = 256, raw = false) {
...
export async function debugProcTexture(engine, id, size = 128) {
