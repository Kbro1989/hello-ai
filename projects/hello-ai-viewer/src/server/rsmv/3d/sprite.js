...
export class ParsedTexture {
    constructor(img, stripAlpha, premultipliedAlpha) {
        this.filesize = 0; // Assuming a default value or it will be set later
        this.img = img;
        this.stripAlpha = stripAlpha;
        this.premultipliedAlpha = premultipliedAlpha;
    }
    toImageData() {
        // Implement logic to return ImageData, potentially applying stripAlpha/premultipliedAlpha
        // For now, just return the raw image data
        return this.img;
    }
}
export function parseSubsprite(buf, palette, width, height, alpha, transposed) {
...
export function parseLegacySprite(metafile, buf) {
...
export function expandSprite(subimg) {
...
export function parseSprite(buf) {
...
export function parseTgaSprite(file) {
