...
export function readKtx(filedata) {
...
export function readDds(filedata) {
    let offset = 0;
 ...
 */
export function loadDds(filedata, paddingsize = -1, forceOpaque = true) {
 ...
 * @param padding size to subtract, will auto-detect to create power of 2 sprite if left at -1
 */
export function loadKtx(filedata, paddingsize = -1, forceOpaque = true) {
