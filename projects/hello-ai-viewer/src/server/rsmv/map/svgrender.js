import { squareLevels } from "../3d/mapsquare";
...
export async function jsonIcons(engine, locs, rect, maplevel) {
...
export async function svgfloor(engine, grid, locs, rect, maplevel, pxpertile, wallsonly, drawicons, thicklines = false) {
