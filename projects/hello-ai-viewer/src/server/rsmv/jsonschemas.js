...
export function assertSchema(v, schema) {
    mustBeValid(validate(v, schema));
}
export function parseJsonOrDefault(str, schema, defaultvalue) {
    try {
...
export const scenarioStateSchema = {
    properties: {
        components: {
            type: "object",
...
export const maprenderConfigSchema = {
    properties: {
        tileimgsize: number,
        mapsizex: number,
        mapsizez: number,
