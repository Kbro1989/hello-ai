...
export var filerange = literal({
    files: cmdts.option({ long: "ids", short: "i", type: FileRange, defaultValue: () => [{ start: [0, 0, 0], end: [Infinity, Infinity, Infinity] }] })
});
...
export function cliArguments(argv) {
...
export function runCliApplication(runner) {
