...
export default class VR360Viewer {
    constructor(imgsrc) {
        ...
        this.dragspeed = 0.1 * Math.PI / 180; //deg per pixel
        this.pendingFrame = 0;
        this.onScroll = (e) => {
        ...
        this.onMouseDown = (e) => {
            ...
            let touchmove = (e2) => {
                ...
                if (e2.touches.length >= 2) {
                    ...
                    if (lasttouchgap > 0) {
                        this.updateZoom((gap - lasttouchgap) / 100);
                    }
                    lasttouchgap = gap;
                }
            };
        ...
        this.draw = () => {
            ...
            let newwidth = gl.canvas.clientWidth;
            let newheight = gl.canvas.clientHeight;
