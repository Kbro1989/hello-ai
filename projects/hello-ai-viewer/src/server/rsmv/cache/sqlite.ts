...
export class GameCacheLoader extends cache.CacheFileSource {
	...
	async openTable(major: number) {
		let sqlite: typeof import("sqlite3") = nonWebpackRequire("sqlite3");
