...
const classicGroupNames = Object.fromEntries(Object.entries(classicGroups)
    .map(([name, id]) => [id, name]));
export function detectClassicVersions(filenames) {
    let versions = [];
...
export async function classicConfig(source, buildnr) {
