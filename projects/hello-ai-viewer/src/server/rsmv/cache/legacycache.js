...
//pre-2006 caches
export function parseLegacyArchive(file, major, isclassic) {
...
export async function legacyPreload(engine) {
...
export async function parseLegacyImageFile(source, buf) {
...
export async function combineLegacyTexture(engine, name, subname, useTga) {
