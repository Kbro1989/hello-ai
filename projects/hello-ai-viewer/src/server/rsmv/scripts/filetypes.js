...
import { archiveToFileId, fileIdToArchiveminor } from "../cache";
...
export const cacheFileJsonModes = constrainedMap()({
...
const cacheFileDecodersImage = constrainedMap()({
...
const cacheFileDecodersLegacyImage = constrainedMap()({
...
const cacheFileDecodersSound = constrainedMap()({
    sounds: decodeSound(cacheMajors.sounds, true),
    musicfragments: decodeSound(cacheMajors.music, false),
    music: decodeMusic,
});
const cacheFileDecodersInteractive = constrainedMap()({
...
const cacheFileDecodersOther = constrainedMap()({
    bin: decodeBinary,
