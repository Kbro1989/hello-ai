...
export function minimapLocMaterial(texture, alphamode, alphathreshold) {
...
export function minimapFloorMaterial(texture) {
    let mat = new ShaderMaterial();
    mat.uniforms = {
        uAmbientColour: { value: [0.6059895753860474, 0.5648590922355652, 0.5127604007720947] },
        uAtlasMeta: { value: [512, 16, 0.0001220703125, 4] },
...
export function minimapWaterMaterial(texture) {
    let mat = new ShaderMaterial();
