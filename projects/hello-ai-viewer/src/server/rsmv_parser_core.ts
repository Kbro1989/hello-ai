...
import type { DebugData } from "./types/rsmv";
...
var debugdata: DebugData | null = null;
...
function opcodesParser(chunkdef: object, parent: ChunkParentCallback, typedef: TypeDef): ChunkParser {
    let r: ChunkParser = {
        read(state) {
...
function literalValueParser(constvalue: unknown): ChunkParser {
    ...
    let r: ChunkParser = {
        ...
        getJsonSchema() {
            return { const: constvalue } as any;
        }
    }
    return r;
}
